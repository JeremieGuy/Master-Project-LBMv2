...
########################### Flow definition #############################################
# iterations
maxIter = 1# Total number of time iterations.
...
new_dir_monitoring = "./Monitoring/FF_loop_branch_clotv3_FULLFF_"+str(nx)+"x"+str(ny)+"_viscosity=" + str(nulb) + "_Rho=" + str(initialDensity) 
...
# adding branch
bounceback[tubeSize+1:(nx-1-tubeSize),1+2*tubeSize+1:1+3*tubeSize+1] = False
