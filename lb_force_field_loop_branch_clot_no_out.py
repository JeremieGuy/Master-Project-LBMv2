...
# Pulsing field mask for fluid aceleration in the lower left tube section
...
# mainDirectory, clotDirectory, velocityDirectory, _ = createRepositories(maxIter,nx,ny,viscosity,initialDensity,F_initial,K_initial)
