...
maxIter = 33333# Total number of time iterations.
...
K_initial = [0,0] # initial resisting force of porous region K[2,x,y]
...
def plotSystem():
    ...
    flagsname = ["Open Path", "Bounceback", "Pulse Field","Inlet", "Outlet"]
...
new_dir_monitoring = "./Monitoring/FF_loop_viscosity=" + str(nulb) + "_Rho=" + str(initialDensity) 
...
# flags_plot[nx//2,(ny-1-tubeSize):ny-1] = 4
