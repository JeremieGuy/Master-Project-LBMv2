...
def drawClotVelocitiesDensityPressure():
    ...
    debit = mean(sqrt(u[0]**2+u[1]**2).transpose(),axis=0)*densityFull
...
if savefiles : 
    new_dir_monitoring = "./Monitoring/tube_u_clot_v2_gamma=" +str(gamma) + "_nulb=" + str(nulb) +  "_it=" + str(maxIter)
