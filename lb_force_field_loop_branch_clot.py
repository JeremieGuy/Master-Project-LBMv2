...
# Max iterations
maxIter = 10000                 # Total number of iterations (dt = 1)
...
K_initial = [0.02,0.02]         # Initial resisting force of porous region K[2,nx,ny]
...
mainDirectory, clotDirectory, velocityDirectory = createRepositories(maxIter,nx,ny,viscosity,initialDensity,F_initial,K_initial)
-> if only some directories are needed : 
mainDirectory, clotDirectory, _ = createRepositories(maxIter,nx,ny,viscosity,initialDensity,F_initial,K_initial)
...
plotResults(clotDirectory, nx, tubeSize, clotCoord, u, rho, execTime+1)
plotVelocityProfiles(velocityDirectory, nx, ny, tubeSize, u, execTime+1)